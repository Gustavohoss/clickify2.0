    ...
    <Card className="p-4">
        ...
        <ResponsiveContainer width="100%" height={200}>
            ...
            >
                ...
                />
                {showArea && <Area type="monotone" dataKey="value" stroke="hsl(var(--primary))" fill={`url(#colorGradient-${uniqueId})`} strokeWidth={2} />}
...
const emojiCategories = {
    ...
    'Activities': ['⚽️', '🏀', '🏈', '⚾️', '🥎', '🎾', '🏐', '🏉', '🥏', '🎱', '🪀', '🏓', '🏸', '🏒', '🏑', '🥍', '🏏', '🥅', '⛳️', '🪁', '🏹', '🎣', '🤿', '🥊', '🥋', '🎽', '🛹', '🛷', '⛸️', '🥌', '🎿', '⛷️', '🏂', '🪂', '🏋️‍♀️', '🏋️‍♂️', '𤼼‍♀️', '𤼼‍♂️', '🤸‍♀️', '🤸‍♂️', '🤺', '𤾾‍♀️', '𤾾‍♂️', '🏌️‍♀️', '🏌️‍♂️', '🏇', '🧘‍♀️', '🧘‍♂️', '🏄‍♀️', '🏄‍♂️', '🏊‍♀️', '🏊‍♂️', '🤽‍♀️', '🤽‍♂️', '🚣‍♀️', '🚣‍♂️', '🧗‍♀️', '🧗‍♂️', '🚵‍♀️', '🚵‍♂️', '🚴‍♀️', '🚴‍♂️', '🏆', '🥇', '🥈', '🥉', '🏅', '🎖️', '🏵️', '🎗️', '🎫', '🎟️', '🎪', '🤹‍♀️', '🤹‍♂️', '🎭', '🩰', '🎨', '🎬', '🎤', '🎧', '🎼', '🎹', '🥁', '🎷', '🎺', '🎸', '𪕕', '🎻', '🎲', '♟️', '🎯', '🎳', '🎮', '🎰', '🧩'],
