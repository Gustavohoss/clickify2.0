      ...
      <AlertDialog open={showVerificationPopup} onOpenChange={setShowVerificationPopup}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter className="sm:justify-center flex-col-reverse sm:flex-row gap-2">
            <AlertDialogCancel onClick={() => setShowVerificationPopup(false)}>Entendi</AlertDialogCancel>
            <AlertDialogAction asChild className="bg-green-600 hover:bg-green-700">
                <a href="https://wa.me/55DD9XXXXXXXX" target="_blank" rel="noopener noreferrer">
